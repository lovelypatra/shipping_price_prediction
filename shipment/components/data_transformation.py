...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->artifact_entity.DataTransformationArtifact:
        try:
            ...
            utils.save_object(file_path = self.data_transformation_config.input_transformer_object_path, obj = preprocessing_input_object)
            utils.save_object(file_path = self.data_transformation_config.target_transformer_object_path, obj = preprocessing_target_object)
