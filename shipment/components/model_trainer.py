...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->artifact_entity.ModelTrainerArtifact:
        try:
            ...
            logging.info(f"calculating train r2 score") 
            yhat_train = model.predict(X_train)
            train_r2_score = r2_score(y_true = y_train, y_pred = yhat_train)

            logging.info(f"calculating test r2 score") 
            ...
            logging.info(f"checking if model is underfitted or not")
            ...
            logging.info(f"checking if model is overfitted or not")
